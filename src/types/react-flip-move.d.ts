...
// redeclare typing file to solve this problem https://github.com/joshwcomeau/react-flip-move/issues/269
// add `children?:React.ReactNode` to fix typing issues with React 18
declare module "react-flip-move" {
  import { Component, ReactElement, ReactNode } from "react";

  export default FlipMove;

  class FlipMove extends Component<FlipMove.FlipMoveProps, any> {}
  ...
  namespace FlipMove {
    ...
    interface FlipMoveProps {
       ...
       */
      onStartAll?(
        childElements: Array<ReactElement<any>>,
